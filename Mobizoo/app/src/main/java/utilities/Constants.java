...
public class Constants {
    public static final String BASE_URL = "http://10.10.32.108:8000";
    ...
    public static final String SAVE_BANK_DETAILS_URL = BASE_URL+"/api/user_api/bank_details/?format=json&type=user";
}
